    ...
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#f8fafc 0%,#e2e8f0 100%)",padding:"40px 20px"}}>
      <div style={{maxWidth:"1400px",margin:"0 auto"}}>
        ...
        <p style={{fontSize:"1.3rem",color:"#64748b",textAlign:"center",marginBottom:"50px"}}>
          Dubai Visa Processing • 24-72 Hours • Starting AED 99
        </p>

        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(400px,1fr))",gap:"30px"}}>
          
          {/* UAE Visa */}
          <div style={{background:"white",borderRadius:"24px",padding:"40px",boxShadow:"0 20px 60px rgba(0,0,0,0.1)",border:"1px solid #f1f5f9"}}>
            <div style={{width:"80px",height:"80px",background:"linear-gradient(135deg,#059669,#10b981)",borderRadius:"20px",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px",fontSize:"24px",color:"white",fontWeight:"bold"}}>
              UAE
            </div>
          ...
          {/* India Visa */}
          <div style={{background:"white",borderRadius:"24px",padding:"40px",boxShadow:"0 20px 60px rgba(0,0,0,0.1)",border:"1px solid #f1f5f9"}}>
            <div style={{width:"80px",height:"80px",background:"linear-gradient(135deg,#ef4444,#dc2626)",borderRadius:"20px",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px",fontSize:"20px",color:"white",fontWeight:"bold"}}>
              IND
            </div>
          ...
          {/* Schengen Visa */}
          <div style={{background:"white",borderRadius:"24px",padding:"40px",boxShadow:"0 20px 60px rgba(0,0,0,0.1)",border:"1px solid #f1f5f9"}}>
            <div style={{width:"80px",height:"80px",background:"linear-gradient(135deg,#3b82f6,#1d4ed8)",borderRadius:"20px",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 20px",fontSize:"18px",color:"white",fontWeight:"bold"}}>
              EU
            </div>
