      ...
      <div style={{maxWidth:"1400px",margin:"0 auto"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(400px,1fr))",gap:"30px"}}>
          <div style={{background:"white",borderRadius:"24px",padding:"40px",boxShadow:"0 20px 60px rgba(0,0,0,0.1)"}}>
            ...
            <a href="https://wa.me/971565669072?text=I want UAE Visa AED 99" style={{display:"block",background:"linear-gradient(135deg,#10b981,#059669)",color:"white",padding:"20px",borderRadius:"16px",textAlign:"center",fontWeight:600,fontSize:"18px",textDecoration:"none"}}>
              Apply Now → WhatsApp
            </a>
          </div>
          ...
          <div style={{background:"white",borderRadius:"24px",padding:"40px",boxShadow:"0 20px 60px rgba(0,0,0,0.1)"}}>
            ...
            <a href="https://wa.me/971565669072?text=India eVisa AED 149" style={{display:"block",background:"linear-gradient(135deg,#ef4444,#dc2626)",color:"white",padding:"20px",borderRadius:"16px",textAlign:"center",fontWeight:600,fontSize:"18px",textDecoration:"none"}}>
              Apply Now → WhatsApp
            </a>
          </div>
        </div>
